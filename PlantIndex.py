...
class PlantIndex:
    def __init__(self,image2analysis,time):
        self.image2analysis = image2analysis
        self.time = time
    ...
    def analysis_save_plant_index(self):
         data = {
                'image2analysis': self.image2analysis,
                'time': self.time,
                'NDVI': self.analysis,
            }
        self.collection.insert_one(data)
    def analysis(self,img_nir,img_rgb):
        self.img_nir = img_nir
        ...
        plt.imsave(
            f'/Desktop/thesis/images/ndvi_{time}.png',          
            ndvi,                       
            cmap='RdYlGn',              
            vmin=-1,                    
            vmax=1,                     
    ...
    return f'/Desktop/thesis/images/ndvi_{time}.png'
    
    def image_alignment(self):
        sift = cv2.SIFT_create()
        kp1, des1 = sift.detectAndCompute(self.img_nir, None)
        kp2, des2 = sift.detectAndCompute(self.img_rgb, None)
        ...
        img_warp = cv2.warpPerspective(self.img_nir, H, (width,height))
        return img_warp
